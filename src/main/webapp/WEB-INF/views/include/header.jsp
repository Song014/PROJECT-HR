        ...
        <div>
            ...
            <div href="/emp.do?cate=nav-emp" id="nav-emp" class="nav_link collapse">
                ...
                <ul class="collapse_menu">
                    ...
                    <!--  <a href="/WEB-INF/views/admin/manage/workSchedulTempView.jsp" class="collapse_sublink">근무일정템플릿</a><br>
                    <a href="/WEB-INF/views/admin/manage/vacationRulesView.jsp" class="collapse_sublink">휴가발생규칙</a><br> -->
                </ul>
            </div>
